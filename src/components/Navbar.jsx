          ...
          <Toolbar disableGutters>
            <Link to="/">
              ...
              >
                <img
                  width={40}
                  src="https://cdn-icons.flaticon.com/png/512/735/premium/735713.png?token=exp=1644398649~hmac=5e62e221637657bdd59f10c811d0062e"
                  alt=""
                />{" "}
                Wilderness Travel
              </Typography>
              ...
              <Link to="/cart">
                <IconButton size="large" color="inherit">
                  <Badge color="error" badgeContent={cartCount}>
                    <img
                      width={30}
                      src="https://cdn-icons-png.flaticon.com/512/6817/6817745.png"
                      alt=""
                    />
                  </Badge>
                </IconButton>
